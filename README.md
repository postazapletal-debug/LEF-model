...
|---|---|---|
| **A** | [Philosophical and social-science foundations]([path]) | *Why* three dimensions, what the axes mean, which hypotheses follow |
| **B** | [Geometry and mathematics]([path]) | *How* positions and the shape of a society are computed |
| **C** | [Methodology, database and empirical testing]([path]) | *From what data* the model is computed and how it is tested |
